...
const EditDamageControlForm = ({route}) => {
    const details = route.params.data;
    const navigation = useNavigation();
    const screenWidth = Dimensions.get('window').width;

    const [inputs, setInputs] = useState(details.damages);
    ...
    const submitHandler = ()=>{
        ...
        navigation.navigate('EditRentEstimationScreen', {
            data: {
                carDetails: details,
                damages: inputs,
                estRent: estRent,
...
export default EditDamageControlForm
